...
<div class="tabs-estado" role="tablist" aria-label="Filtrar autores por estado">
    <button type="button" 
            role="tab"
...
<div class="toolbar">
    <div class="buscador">
        <label for="buscador" class="sr-only">Buscar autores</label>
        <input 
            type="search" 
            id="buscador" 
...
<?php if (isset($_GET['exito'])): ?>
    <div class="alertas-contenedor">
        <div class="alerta alerta-exito" role="alert" aria-live="polite">
            <?php 
                switch ($_GET['exito']) {
                    case '1': echo 'Autor creado correctamente.'; break;
                    case '2': echo 'Autor actualizado correctamente.'; break;
                    case '3': echo 'Autor dado de baja correctamente.'; break;
                    case '4': echo 'Autor activado correctamente.'; break;
                }
            ?>
        </div>
    </div>
