...
<div class="form-card">
    <h2><?= htmlspecialchars($titulo ?? 'Editar Libro') ?></h2>

    <form method="POST" action="/libros/editar?id=<?= (int) $libro->id ?>" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-grid">
            ...
            <div class="campo">
                <label for="portada">Nueva portada</label>
                <input
                    type="file"
                    id="portada"
                    name="portada"
